...
### Key rebindings
Customize the modifier keys in the system preference.
...
```
### .zshrc
1. Check the existing shells, and set zsh as default shell for current user
...
### Configure python environment (only works for macOS X)
...
<h2 id="3"> Windows </h2>
Currently, Windows part works for sub-system linux in Windows 10.
